...
public class SecondLevelAdapterDelegate extends AdapterDelegate<ExpandableList>
{
    private final FirstSecondThirdLevelClickListener firstSecondThirdLevelClickListener;

    public SecondLevelAdapterDelegate(FirstSecondThirdLevelClickListener listener)
    {
    ...
    {
        return items.get(position) instanceof SecondLevelRowData;
    }
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.second_level_row, parent, false);
