...
public class ThirdLevelAdapterDelegate extends AdapterDelegate<ExpandableList>
{
    private final FirstSecondThirdLevelClickListener firstSecondThirdLevelClickListener;

    public ThirdLevelAdapterDelegate(FirstSecondThirdLevelClickListener listener)
    {
    ...
    {
        return items.get(position) instanceof ThirdLevelRowData;
    }
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.third_level_row, parent, false);
